...
- (id)initWithDataMethod:(NSString*)dataMethod frame:(CGRect)frame andDelegate:(id <FMScrollViewManagerDelegate>)delegate{
    return [self initWithDataMethod:dataMethod frame:frame andDelegate:delegate defaultClassType:@"FMScrollViewCell" otherParams:nil];
}

- (id)initWithDataMethod:(NSString*)dataMethod frame:(CGRect)frame andDelegate:(id <FMScrollViewManagerDelegate>)delegate  otherParams:(NSMutableDictionary *)otherParams{
    return [self initWithDataMethod:dataMethod frame:frame andDelegate:delegate defaultClassType:@"FMScrollViewCell" otherParams:otherParams];
}
- (id)initWithDataMethod:(NSString*)dataMethod frame:(CGRect)frame andDelegate:(id <FMScrollViewManagerDelegate>)delegate defaultClassType:(NSString*)classType otherParams:(NSMutableDictionary *)otherParams{
    
    return [self initWithDataMethod:dataMethod frame:frame andDelegate:delegate defaultClassType:classType numberColumns:10 startY:0.0f otherParams:otherParams];
}


- (id)initWithDataMethod:(NSString*)dataMethod frame:(CGRect)frame andDelegate:(id <FMScrollViewManagerDelegate>)delegate defaultClassType:(NSString*)classType startY:(CGFloat)startY otherParams:(NSMutableDictionary *)otherParams{
    
    return [self initWithDataMethod:dataMethod frame:frame andDelegate:delegate defaultClassType:classType numberColumns:10 startY:startY otherParams:otherParams];
}

- (id)initWithDataMethod:(NSString*)dataMethod frame:(CGRect)frame andDelegate:(id <FMScrollViewManagerDelegate>)delegate defaultClassType:(NSString*)classType numberColumns:(NSInteger)numberColumns startY:(CGFloat)startY otherParams:(NSMutableDictionary *)otherParams {
    CGFloat columnWidth = frame.size.width/numberColumns;
    return [self initWithDataMethod:dataMethod frame:frame andDelegate:delegate defaultClassType:classType columnWidth:columnWidth startY:startY leftMarginCols:1 otherParams:otherParams needPzRefreshControl:NO];
}

- (id)initWithDataMethod:(NSString*)dataMethod frame:(CGRect)frame andDelegate:(id <FMScrollViewManagerDelegate>)delegate defaultClassType:(NSString*)classType columnWidth:(CGFloat)columnWidth startY:(CGFloat)startY leftMarginCols:(NSInteger)leftMarginCols otherParams:(NSMutableDictionary *)otherParams needPzRefreshControl:(BOOL)needPzRefreshControl{

    return [self initWithDataMethod:dataMethod frame:frame andDelegate:delegate defaultClassType:classType columnWidth:columnWidth startY:startY leftMarginCols:leftMarginCols cellPaddingTop:0 otherParams:otherParams needPzRefreshControl:needPzRefreshControl];
}
...
//            }
        ...
        [[FMDataManager sharedFMDataManger] fetchDataFromServerWithDataMethod:self.dataMethod page:self.page otherParams:self.otherParams success:^(id data) {
            ...
            if(count==0){
                ...
                if (strongSelf.page == 1) {
                    strongSelf.lastUpDateTime = [NSString getTimeSp];
                }
                [strongSelf.otherParams setValue:@(self.lastUpDateTime) forKey:@"lastUpDateTime"];
